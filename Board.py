...
class Board():
    ...
    def from_dict(cls, data):
        ...
        board.robbed_tile = board.tiles[data['robbed_tile'][0]][data['robbed_tile'][1]]
        ...
        board.village_locations = [board.get_point_board(k[0], k[1]) for k in data['village_locations']]
        board.road_locations = [set([board.get_point_board(k[0], k[1]), board.get_point_board(k[2], k[3])]) for k in data['road_locations']]
        board.robbed_tile = board.tiles[data['robbed_tile'][0]][data['robbed_tile'][1]]
